...
srun python run_experiment.py --experiment imitation --configfile imitation/experiment_config.yaml --logdir imitation/results/test --datadir imitation/data --mp mp
