...
### Evaluator for graph classification - edited version of ogb Evaluator
class Evaluator:
    def __init__(self, name, eval_metric='accuracy'):
        self.name = name
        ...
        self.num_tasks = 1  #int(meta_info[self.name]["num tasks"])
        # possible eval_metric: "rocauc", 'prcauc', "rmse", "accuracy"
