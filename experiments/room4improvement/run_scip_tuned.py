...
def submit_job(jobname, nnodes, nodeid, time_limit_hours, time_limit_minutes):
    ...
    with open(job_file, 'w') as fh:
        ...
        fh.writelines(f'python run_scip_tuned.py --configfile {args.configfile} --rootdir {args.rootdir} --nnodes {nnodes} --ncpus_per_node {args.ncpus_per_node} --nodeid {nodeid} --run_node\n')
