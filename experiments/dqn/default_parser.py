...
parser.add_argument("--hide_scip_output", type=int, default=True, help="avoids printing scip messages to the console")
...
parser.add_argument("--overfit", type=int, default="validset25", help="specify dataset to train and validate on")
