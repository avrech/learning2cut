...
parser.add_argument("--reset_maxcuts_every_round", type=str2bool, nargs='?', const=True, default=False, help="avoids undesired 'unoughcuts' in SCIPseparationRoundLP")
...
# parser.add_argument("--replay_server_2_workers_pubsub_port", type=int, default=5554, help="port number to send buffer request to workers")
# parser.add_argument("--learner_2_workers_pubsub_port", type=int, default=5555, help="port number to publish new model parametersto to workers")
...
# parser.add_argument("--min_port", type=int, default=5000, help="min port number")
# parser.add_argument("--port_range", type=int, default=10000, help="range for random port binding")
